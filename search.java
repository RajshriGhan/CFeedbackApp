...
public class search extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText textViewDate = findViewById(R.id.writeage);
        Date timenow = Calendar.getInstance().getTime();
        textViewDate.setText(timenow.toString());

        txtname.setText(getIntent().getStringExtra("responce"));
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (TextUtils.isEmpty(name)) {
                        ...
                        Intent intent=new Intent(search.this,ThankYou.class);
        ...
        customAdapter = new CustomAdapter(search.this,dataArrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView,View view,int i,long l) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(search.this).setView(v);
                ...
                v.findViewById(R.id.update).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Data tempData = new Data(dataArrayList.get(temp).getKey(),updtname.getText().toString().trim(),updtage.getText().toString());
